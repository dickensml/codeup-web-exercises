...
function returnPriceOfBeer(inBasket) {
    if (inBasket.name = 'beer') {
    return inBasket.price;
    }
}


returnPriceOfBeer(inBasket);

function totalPriceOfBasket(input) {

    // let sum = inBasket[0].price;
    // inBasket.forEach(amount => {
    //     sum += inBasket.price;
    // })
    let sum = 0;
